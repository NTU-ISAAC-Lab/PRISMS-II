...
PURPOSE:
    A class of dial with visable values available
...
class ValueDial(QtWidgets.QWidget):
    """Creates a dial with the possible values visable on the edges"""
...
# the following functions are required to correctly update the layout
    ...
    def updateSize(self):
        """a function that sets the margins to ensure that the value strings always have enough space"""
        fm = self.fontMetrics()
